...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Message>(entity =>
        {
            ...
            entity.HasOne(d => d.CompanyStaff).WithMany(p => p.Messages)
                .HasForeignKey(d => d.CompanyStaffId)
            ...
            entity.HasOne(d => d.MessageBox).WithMany(p => p.Messages)
        ...
        modelBuilder.Entity<Tforderlist>(entity =>
        {
            ...
            entity.HasOne(d => d.TforderStatus).WithMany(p => p.Tforderlists)
                .HasForeignKey(d => d.TforderStatusId)
                .HasConstraintName("FK_TFOrderlists_TFOrderStatuses");
